    ...
    checkCompleted: function() {
      ...
      if (cartItems.length) {
        this.ODataHelper.callOData(this.getOwnerComponent().getModel(),
          ...
          .then(function(data) {
            that._oLocalModel.setProperty("/lastOrder/OrderNo", data.OrderNo);
            that._oLocalModel.setProperty("/lastOrder/InvoiceNo", data.InvoiceNo);
            that._oLocalModel.setProperty("/lastOrder/OrderId", data.id);
